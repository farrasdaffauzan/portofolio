      ...
      <div className="container lg:m-auto">
        ...
        <div className="flex flex-wrap w-full items-center lg:mx-5 justify-center">
          <div className="flex flex-row w-full p-3 lg:w-1/2">
            <div className="p-2 w-full">
              <div className="relative shadow-md cursor-pointer overflow-hidden h-full group">
                <img src="images/portofolio.png" alt="Portofolio" className="w-full h-[270px] lg:h-full top-96" />

                <div className="absolute top-0 backdrop-blur-lg z-10 inset-0 translate-y-[240px] lg:translate-y-[300px] lg:content-center lg:px-4 group-hover:translate-y-0 group-hover:duration-500 ">
          ...
          <div className="flex flex-row w-full p-3 lg:w-1/2">
            <div className="p-2 w-full">
              <div className="relative shadow-md cursor-pointer overflow-hidden h-full group">
                <img src="images/SanberDaily.png" alt="Portofolio" className="w-full h-[260px] lg:h-full top-96" />

                <div className="absolute top-0 backdrop-blur-lg z-10 inset-0 translate-y-[230px] lg:translate-y-[300px] lg:content-center lg:px-4 group-hover:translate-y-0 group-hover:duration-500 ">
          ...
          <div className="flex flex-row w-full p-3 lg:w-1/2">
            <div className="p-2 w-full">
              <div className="relative shadow-md cursor-pointer overflow-hidden h-full group">
                <img src="images/Anime.png" alt="Portofolio" className="w-full h-[280px] lg:h-full top-96" />

                <div className="absolute top-0 backdrop-blur-lg z-10 inset-0 translate-y-[250px] lg:translate-y-[310px] lg:content-center lg:px-4 group-hover:translate-y-0 group-hover:duration-500 ">
